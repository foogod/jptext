...
class hiragana (KanaCharacterSet):
    ...
    mora_re = '[' + large + small_non_combining + ligatures + repeats + sokuon + intraword + '][' + stresses + ']?[' + combining + ']?'
    sokuonmora_re = sokuon + '?[' + large + '][' + stresses + ']?[' + combining + ']?|[' + small_non_combining + ligatures + repeats + intraword + ']'
